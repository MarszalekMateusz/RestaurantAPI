...
namespace RestaurantAPI.Services
{
    ...
    public class RestaurantService : IRestaurantService
    {
        ...
        private readonly ILogger<RestaurantService> _logger; //l

        public RestaurantService(RestaurantDbContext dbContext, IMapper mapper, ILogger<RestaurantService> logger) //l
        {
